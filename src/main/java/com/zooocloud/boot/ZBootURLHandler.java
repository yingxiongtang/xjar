 ...
 * 2018/11/24 13:19
 */
public class ZBootURLHandler extends Handler implements ZConstants {
    private final ZDecryptor zDecryptor;
    private final ZEncryptor zEncryptor;
    private final ZKey zKey;
    private final Set<String> indexes;

    public ZBootURLHandler(ZDecryptor zDecryptor, ZEncryptor zEncryptor, ZKey zKey, ClassLoader classLoader) throws Exception {
    ...
    protected URLConnection openConnection(URL url) throws IOException {
        ...
        return indexes.contains(url.toString())
                ...
                ? new ZBootURLConnection((JarURLConnection) urlConnection, zDecryptor, zEncryptor, zKey)
                : urlConnection;
    }
