 ...
 * 2018/11/24 13:57
 */
public class ZBootURLConnection extends JarURLConnection {
    ...
    public ZBootURLConnection(JarURLConnection jarURLConnection, ZDecryptor zDecryptor, ZEncryptor zEncryptor, ZKey zKey) throws MalformedURLException {
    ...
    public InputStream getInputStream() throws IOException {
        ...
        return zDecryptor.decrypt(zKey, in);
    }

    @Override
    public OutputStream getOutputStream() throws IOException {
        OutputStream out = jarURLConnection.getOutputStream();
        return zEncryptor.encrypt(zKey, out);
    }
