 ...
 * 2018/11/24 13:57
 */
public class ZJarURLConnection extends JarURLConnection {
    ...
    public ZJarURLConnection(JarURLConnection jarURLConnection, ZDecryptor zDecryptor, ZEncryptor zEncryptor, ZKey zKey) throws MalformedURLException {
