 ...
 * 2018/12/7 11:27
 */
public abstract class ZRegexEntryFilter<E> implements ZEntryFilter<E> {
    protected final Pattern pattern;

    protected ZRegexEntryFilter(String regex) {
        this(Pattern.compile(regex));
    }

    protected ZRegexEntryFilter(Pattern pattern) {
